...
function recastWSSocket(socket, req) {
  var WSSocket = /*#__PURE__*/function (_EventEmitter) {
...
function getWrappedWSServer() {
  var wss;
  return /*#__PURE__*/function (_EventEmitter2) {
    _inherits(ProxiedWSServer, _EventEmitter2);

    var _super2 = _createSuper(ProxiedWSServer);
    ...
    function ProxiedWSServer(opts) {
      ...
      _this2 = _super2.call(this); // opts.server that comes in is our remapped server, so we
      // get the original
...
function recastHTTPReq(req) {
  var ProxiedHTTPRequest = /*#__PURE__*/function (_EventEmitter3) {
    _inherits(ProxiedHTTPRequest, _EventEmitter3);

    var _super3 = _createSuper(ProxiedHTTPRequest);
...
function recastHTTPRes(res) {
  var ProxiedHTTPResponse = /*#__PURE__*/function () {
...
function createWrappedHTTPServer() {
  ...
  var ProxiedHTTPServer = /*#__PURE__*/function (_EventEmitter4) {
    _inherits(ProxiedHTTPServer, _EventEmitter4);

    var _super4 = _createSuper(ProxiedHTTPServer);
